...
execute in overworld positioned 0.0 0.0 0.0 run data modify storage syk9lib: mcid set from entity @n[type=armor_stand,tag=this,distance=..1] equipment.head.components."minecraft:profile".name
