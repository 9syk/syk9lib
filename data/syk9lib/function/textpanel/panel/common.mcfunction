...
execute if score @s syk9lib.textpanel matches -4 run return run function syk9lib:textpanel/convert {data:"　"}
execute if score @s syk9lib.textpanel matches -5 run return run function syk9lib:textpanel/ok
